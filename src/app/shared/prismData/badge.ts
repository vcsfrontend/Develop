export let badgeTS = `<span class="badge bg-primary">Primary</span>
...
export let badgeTS1 = `<span class="badge bg-primary-transparent">Primary</span>
...
export let badgeTS2 = `<span class="badge rounded-pill bg-primary">Primary</span>
...
export let badgeTS3 = ` <span class="badge rounded-pill bg-primary-transparent">Primary</span>
...
export let badgeTS4 = `<span class="badge bg-primary-gradient">Primary</span>
...
export let badgeTS5 = ` <span class="badge rounded-pill bg-primary-gradient">Primary</span>
...
export let badgeTS6 = ` <span class="badge bg-outline-primary">Primary</span>
...
export let badgeTS7 = ` <span class="badge rounded-pill bg-outline-primary">Primary</span>
...
export let badgeTS8 = ` <button type="button" class="btn btn-primary my-1 me-2">
...
export let badgeTS9 = ` <button type="button" class="btn btn-outline-primary my-1 me-2">
...
export let badgeTS10 = ` <button type="button" class="btn btn-primary position-relative">
Inbox
<span
...
export let badgeTS12 = ` <h1>Example heading <span class="badge bg-primary">New</span></h1>
